...
class CSPresetTestPresetItemList : renetik.android.preset.CSPresetDataList<CSPresetTestPresetItem> {
    ...
    override fun createItem(title: String, isDefault: Boolean): CSPresetTestPresetItem {
